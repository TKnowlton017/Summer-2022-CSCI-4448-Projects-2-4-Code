...
abstract class Item {
    ...
    // helper functions
    protected String getRandomElement(String[] list) {
...
//Ferret inherits from Pet
class Ferret extends Pet {
    public String color;
    public boolean housebroken;

    public Ferret(int dayArrived) {
        super(dayArrived);
        this.name = "Ferret";

        String[] colors = {"yellow", "brown", "black"};
        this.color = getRandomElement(colors);
        this.housebroken = getRandomBoolean();
    }
    ...
    @Override
    public String summary() {
        return String.format("%s ferret", color);
    }
}
...
class Snake extends Pet {
    ...
    @Override
    public String summary() {
        return String.format("%s snake", size);
    }
}
...
class Food extends Supplies {
    ...
    public Food(int dayArrived) {
        ...
        this.name = "Food";
        String[] sizes = {"small", "medium", "big"};
        String[] animals = {"dog", "cat", "bird", "ferret", "snake"};
...
//Treats inherits from Supplies
class Treat extends Supplies {
    public String animal;

    public Treat(int dayArrived) {
        super(dayArrived);
    ...
    @Override
    public String summary() {
        return String.format("%s treats", animal);
    }
}
